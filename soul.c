...
#define EXPIRY_DATE "2026-01-01"  // Updated expiry date
#define DEFAULT_PACKET_SIZE 512   // Increased packet size
#define DEFAULT_THREAD_COUNT 5000  // Increased default threads
#define MAX_THREADS 10000          // Safety limit
...
void print_banner() {
    printf("\n");
    printf("\033[1;91m"); // Red bold color
    printf("██████╗  █████╗ ██╗   ██╗██╗    ██████╗  ██████╗ ███████╗███████╗\n");
    printf("██╔══██╗██╔══██╗██║   ██║██║    ██╔══██╗██╔═══██╗██╔════╝██╔════╝\n");
    printf("██████╔╝███████║██║   ██║██║    ██████╔╝██║   ██║███████╗█████╗  \n");
    printf("██╔═══╝ ██╔══██║╚██╗ ██╔╝██║    ██╔═══╝ ██║   ██║╚════██║██╔══╝  \n");
    ...
    printf("\033[1;96m║                        \033[1;91m🔥  \033[1;97mR RAVI BoSS OwN \033[1;91m  🔥                            \033[1;96m║\n");
    printf("\033[38;2;255;105;180m╠═════════════════════════════════════════════════════════════════════════════╣\n");

    printf("\033[1;94m║ \033[0;97m👨‍💻  \033[1;97mDEVELOPER   : \033[38;2;0;255;255m⎯꯭𓆰꯭ RAVI BOSS™ x DDOS™                          \033[1;94m║\n");
    printf("\033[1;91m║ \033[0;97m⏳  \033[1;97mVALID TILL  : \033[0;32m%s                                            \033[1;91m║\n", EXPIRY_DATE);
    printf("\033[1;93m║ \033[0;97m📡  \033[1;97mTELEGRAM    : \033[0;36mhttps://t.me/RAVI_BOSS77                         \033[1;93m║\n");
...
int check_expiry() {
    ...
    if (diff < 0) {
        ...
        printf("\033[1;33m[!] Contact @RAVI_BoSs_OwN for updates\033[0m\n\n");
        return 1;
    }
...
printf(  "\033[1;91m║   🔥 DEVELOPED BY : \033[1;5;95m@RAVI_BoSs_OwN × DILDOS™\033[0m%40s\033[38;2;255;20;147m║\033[0m\n", "");
